# -*- coding: utf-8 -*-
"""
Created on Fri Apr 17 19:07:43 2020
...
def write_playlist(username, playlist_id):
    ...
    df_rock = write_tracks(text_file, tracks)
    return df_rock
...
# example playlist
df_rock = write_playlist('abc', '1HJ2Jru6mKA7637tdtGflM')
...
frames = [df_lofi,df_rock,df_dance]
